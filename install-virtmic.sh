...
pactl load-module module-pipe-source source_name=virtmic file=/home/$USER/audio/virtmic format=s16le rate=16000 channels=1
...
#while true; do
#    cat audioFile0.raw > /home/$USER/audio/virtmic
#done
